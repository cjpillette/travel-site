...
/***/ function(module, exports, __webpack_require__) {
	...
	var Modal = function () {
		function Modal() {
			...
			this.openModalButton = (0, _jquery2.default)(".open-modal"); /* the blue contact button at top and bottom of site */
			this.modal = (0, _jquery2.default)(".modal"); /* the actual modal window */
			this.closeModalButton = (0, _jquery2.default)(".modal__close"); /* the X from the actual modal window */
			this.events();
		}
		...
		_createClass(Modal, [{
			...
			value: function events() {
				...
				(0, _jquery2.default)(document).keyup(this.keyPressHandler.bind(this)); /* jquery select all doc and when user releases key, lib method, */
			}
		}, {
			key: "keyPressHandler",
			value: function keyPressHandler(e) {
				if (e.keyCode == 27) {
					/*if the key pressed is the escape key; id is always 27 for ESC*/
					this.closeModal();
				}
			}
		}, {
